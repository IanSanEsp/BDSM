...
// Verifica token JWT (Authorization: Bearer <token>) y req.user (obligatorio)
...
// Intenta autenticar: si hay token válido, setea req.user; si no, sigue sin romper
...
export function requireAdmin(req, res, next) {
  ...
  // Soportar variantes BD (ptm fate)
